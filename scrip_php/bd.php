...
try {
	...
	$query="CREATE TABLE IF NOT EXISTS eventos (id INT(11) NOT NULL AUTO_INCREMENT, nombre TEXT, 
		fecha_ini TEXT, fecha_fin TEXT, precio TEXT, publico TEXT, asistentes TEXT, 
		lugar TEXT, recinto TEXT, tipo TEXT, descripcion TEXT, imagen TEXT, mail TEXT,  PRIMARY KEY(id))";
